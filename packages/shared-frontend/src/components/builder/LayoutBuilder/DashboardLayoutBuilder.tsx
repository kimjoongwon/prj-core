...
export const DashboardLayoutBuilder = observer((_props: DashboardLayoutBuilderProps) => {
  ...
  const selectedDashboardRouteChildren = navigation.getSelectedDashboardRouteChildren();
  ...
  return (
    <DashboardLayout
      header={
        <Header
          left={<Logo variants={"text"} onClick={() => navigator.pushByName("대시보드")} />}
