...
export function CrudController(config: CrudConfig) {
  return function <T extends { new (...args: any[]): {} }>(constructor: T) {
    ...
    const methodConfigs = [
      ...
      { name: 'getById', operationId: `get${entityName}ById`, summary: `Get ${lowerEntityName} by ID` },
      { name: 'updateById', operationId: `update${entityName}ById`, summary: `Update ${lowerEntityName} by ID` },
      { name: 'removeById', operationId: `remove${entityName}ById`, summary: `Soft delete ${lowerEntityName} by ID` },
      { name: 'deleteById', operationId: `delete${entityName}ById`, summary: `Hard delete ${lowerEntityName} by ID` },
      { name: 'getManyByQuery', operationId: `get${entityName}sByQuery`, summary: `Get ${lowerEntityName}s by query` }
    ];
