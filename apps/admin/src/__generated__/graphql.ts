...
export type GetCategoriesQuery = { __typename?: 'Query', categories: { __typename?: 'PaginatedCategory', nodes: Array<{ __typename?: 'Category', id: string, name: string, deleted: boolean }>, pageInfo: { __typename?: 'CategoryPageInfo', endCursor?: string | null, totalCount: number } } };
